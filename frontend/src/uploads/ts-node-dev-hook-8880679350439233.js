"use strict";
var fs = require('fs');
var getCompiledPath = require('/user/node_modules/ts-node-dev/lib/get-compiled-path').getCompiledPath;
var sep = require('path').sep;
var join = require('path').join;
var extname = require('path').extname;
var execSync = require('child_process').execSync;
var Module = require('module');
var compilationId = '8880679350439233';
var timeThreshold = 0;
var allowJs = true;
var compiledDir = '/tmp/.ts-node0QNrIK/compiled';
var preferTs = false;
var ignore = [/node_modules/];
var readyFile = '/tmp/ts-node-dev-ready-8880679350439233';
var execCheck = false;
var exitChild = false;
var sourceMapSupportPath = '/user/node_modules/source-map-support/source-map-support.js';
var libPath = '/user/node_modules/ts-node-dev/lib';
var checkFileScript = join("/user/node_modules/ts-node-dev/lib", 'check-file-exists.js');
