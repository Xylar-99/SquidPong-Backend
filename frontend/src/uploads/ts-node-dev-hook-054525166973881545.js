"use strict";
var fs = require('fs');
var getCompiledPath = require('/gateway/node_modules/ts-node-dev/lib/get-compiled-path').getCompiledPath;
var sep = require('path').sep;
var join = require('path').join;
var extname = require('path').extname;
var execSync = require('child_process').execSync;
var Module = require('module');
var compilationId = '054525166973881545';
var timeThreshold = 0;
var allowJs = true;
var compiledDir = '/tmp/.ts-node3k9btd/compiled';
var preferTs = false;
var ignore = [/node_modules/];
var readyFile = '/tmp/ts-node-dev-ready-054525166973881545';
var execCheck = false;
var exitChild = false;
var sourceMapSupportPath = '/gateway/node_modules/source-map-support/source-map-support.js';
var libPath = '/gateway/node_modules/ts-node-dev/lib';
var checkFileScript = join("/gateway/node_modules/ts-node-dev/lib", 'check-file-exists.js');
